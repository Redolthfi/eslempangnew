        ...
        <form method="POST" class="grid sm:grid-cols-2 gap-5">
            ...
            <div class="">
                ...
                <div class="mb-5">
                    ...
                    <x-basic-input type="number" id="harga" name="harga" value="" required />
                </div>
                <div class="mb-5">
                    <x-basic-label for="desc" title="Deskripsi" />
                    <textarea name="description" rows="3" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"></textarea>
                </div>
